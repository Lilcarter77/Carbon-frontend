        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4 pb-12 border-b border-slate-800">
            ...
            <div className="lg:col-span-1 space-y-4">
              ...
              <p className="text-sm text-slate-400 leading-relaxed">
                ...
                choices for a greener Cameroon.
              </p>
              {/* Social Links */}
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:hello@carbontracker eco"
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-300">Douala, Cameroon</p>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm text-slate-500">
              © {new Date().getFullYear()} CarbonTracker eco. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
