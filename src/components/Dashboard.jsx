      ...
      <footer className="mt-20 bg-gradient-to-b from-slate-900 to-slate-950 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4 pb-12 border-b border-slate-800">
            ...
            <div className="lg:col-span-1 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl font-bold">CarbonTracker eco</h3>
                  <p className="text-xs text-slate-400"></p>
                </div>
              </div>
              <p className="text-sm text-slate-400 leading-relaxed">
                Empowering individuals to track their carbon footprint and make sustainable choices for a greener Cameroon
              </p>
              {/* Social Links */}
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@carbontracker eco" className="text-sm text-slate-300 hover:text-emerald-400 transition-colors">
                      hello@carbontracker eco
                    </a>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="tel:+237 655742831" className="text-sm text-slate-300 hover:text-emerald-400 transition-colors">
                      +237 655742831
                    </a>
                  </div>
                </li>
          ...
          <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <span className="text-2xl">Solid</span>
              <p className="text-sm text-slate-400">
                Made by Carter <span className="text-red-500"></span> 
              </p>
            </div>
            <p className="text-sm text-slate-500">
              © {new Date().getFullYear()} CarbonTrackereco. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
